...
using AppSearchPagination.Models;

namespace AppSearchPagination.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Index(int page)
        {
            ...
            return View(await PaginatedList<Employee>.CreateAsync(_context.Employee.AsNoTracking(), page, pageSize));
        }
